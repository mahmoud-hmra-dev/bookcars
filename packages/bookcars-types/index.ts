...
export interface SaleListingFeatureGroups {
  technology: string[]
  safety: string[]
  comfort: string[]
}

export interface SaleListingSeller {
...
export interface SaleListing {
  ...
  description?: string
  images: string[]
  features: SaleListingFeatureGroups
  featured?: boolean
  published?: boolean
  seller: SaleListingSeller
...
export interface UpdateSaleListingPayload extends CreateSaleListingPayload {
  _id: string
}
...
export interface SaleListingSearchResult {
  rows: SaleListing[]
  rowCount: number
}

export interface SaleListingDetailResult {
  listing: SaleListing
  similar: SaleListing[]
}
