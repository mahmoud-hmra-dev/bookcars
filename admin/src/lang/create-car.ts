...
const strings = new LocalizedStrings({
  fr: {
    ...
    TRACCAR_DEVICE_ID: 'Identifiant Traccar',
    TRACCAR_UNIQUE_ID: 'ID unique / IMEI Traccar',
    LICENSE_PLATE_ALREADY_EXISTS: 'Cette plaque d\'immatriculation existe déjà.',
    TRACCAR_DEVICE_IN_USE: 'Cet identifiant Traccar est déjà associé à un véhicule.',
    TRACCAR_UNIQUE_IN_USE: 'Cet ID unique Traccar est déjà associé à un véhicule.',
  ...
  en: {
    ...
    TRACCAR_UNIQUE_ID: 'Traccar Unique ID / IMEI',
    LICENSE_PLATE_ALREADY_EXISTS: 'This license plate already exists.',
    TRACCAR_DEVICE_IN_USE: 'This Traccar device is already linked to another car.',
    TRACCAR_UNIQUE_IN_USE: 'This Traccar unique id is already linked to another car.',
  ...
  es: {
    ...
    TRACCAR_DEVICE_ID: 'ID de dispositivo Traccar',
    TRACCAR_UNIQUE_ID: 'ID único / IMEI de Traccar',
    LICENSE_PLATE_ALREADY_EXISTS: 'Esta matrícula ya existe.',
    TRACCAR_DEVICE_IN_USE: 'Este dispositivo Traccar ya está vinculado a otro coche.',
    TRACCAR_UNIQUE_IN_USE: 'Este ID único de Traccar ya está vinculado a otro coche.',
